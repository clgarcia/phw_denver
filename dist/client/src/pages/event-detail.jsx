...
export default function EventDetail() {
    ...
    }), event = _a.data, isLoading = _a.isLoading, error = _a.error;
    var spotsLeft = event ? event.capacity - event.registeredCount : 0;
    var fillPercentage = event ? (event.registeredCount / event.capacity) * 100 : 0;
      ...
      <main className="flex-1">
        <div className="container mx-auto px-4 py-8">
          ...
          {isLoading ? (<div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            </div>) : error || !event ? (<Card className="p-12 text-center max-w-md mx-auto">
              ...
              <div className="lg:col-span-2 space-y-6">
                <Card>
                  {event.imageUrl ? (<div className="h-64 rounded-t-lg overflow-hidden flex items-center justify-center bg-black/5">
                    ...
                    </div>) : (<div className="h-64 bg-gradient-to-br from-primary/20 to-accent/20 rounded-t-lg flex items-center justify-center">
              ...
              <div className="space-y-6">
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    {spotsLeft > 0 ? (<Link href={"/register?event=".concat(event.id)}>
