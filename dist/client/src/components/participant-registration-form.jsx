...
var MILITARY_STATUSES = ["Active Duty", "Reserve/Guard", "Veteran", "Retired"];
var YES_NO = ["Yes", "No"];
var BRANCHES = [
...
export function ParticipantRegistrationForm(_a) {
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            ...
            return (<FormItem>
                ...
                <FormField control={form.control} name="middleInitial" render={function (_a) {
            var field = _a.field;
            return (<FormItem>
            ...
            return (<FormItem>
                ...
                <FormField control={form.control} name="street" render={function (_a) {
            var field = _a.field;
            return (<FormItem>
            ...
            return (<FormItem>
                    ...
                    <FormControl>
                      <Select value={field.value} onValueChange={field.onChange}>
                        ...
                        <SelectContent>
                          {US_STATES.map(function (state) { return (<SelectItem key={state} value={state}>{state}</SelectItem>); })}
                        </SelectContent>
                      </Select>
                    </FormControl>
                    <FormMessage />
                ...
                <FormField control={form.control} name="postalCode" render={function (_a) {
            var field = _a.field;
            return (<FormItem>
                ...
                <FormField control={form.control} name="country" render={function (_a) {
            var field = _a.field;
            return (<FormItem>
            ...
            return (<FormItem>
                ...
                <FormField control={form.control} name="mobilePhone" render={function (_a) {
            var field = _a.field;
            return (<FormItem>
                ...
                <FormField control={form.control} name="workPhone" render={function (_a) {
            var field = _a.field;
            return (<FormItem>
                ...
                <FormField control={form.control} name="homePhone" render={function (_a) {
            var field = _a.field;
            return (<FormItem>
                ...
                <FormField control={form.control} name="preferredPhone" render={function (_a) {
            var field = _a.field;
            return (<FormItem>
                ...
                <FormField control={form.control} name="birthYear" render={function (_a) {
            var field = _a.field;
            return (<FormItem>
            ...
            return (<FormItem>
                ...
                <FormField control={form.control} name="ethnicity" render={function (_a) {
            var field = _a.field;
            return (<FormItem>
                    ...
                    <FormControl>
                      <Select value={field.value} onValueChange={field.onChange}>
                        ...
                        <SelectContent>
                          {ETHNICITIES.map(function (e) { return (<SelectItem key={e} value={e}>{e}</SelectItem>); })}
                        </SelectContent>
                      </Select>
                    </FormControl>
                    <FormMessage />
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <FormField control={form.control} name="militaryStatus" render={function (_a) {
            var field = _a.field;
            return (<FormItem>
                    ...
                    <FormControl>
                      <Select value={field.value} onValueChange={field.onChange}>
                        ...
                        <SelectContent>
                          {MILITARY_STATUSES.map(function (s) { return (<SelectItem key={s} value={s}>{s}</SelectItem>); })}
                        </SelectContent>
                      </Select>
                    </FormControl>
                    <FormMessage />
                ...
                <FormField control={form.control} name="isDisabledVeteran" render={function (_a) {
            var field = _a.field;
            return (<FormItem>
                ...
                <FormField control={form.control} name="usesVA" render={function (_a) {
            var field = _a.field;
            return (<FormItem>
                ...
                <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                  <FormField control={form.control} name="branchOfService" render={function (_a) {
            var field = _a.field;
            return (<FormItem>
                    ...
                    var _a;
                    return (<label key={branch} className="flex items-center gap-2">
                              <input type="checkbox" checked={((_a = field.value) === null || _a === void 0 ? void 0 : _a.includes(branch)) || false} onChange={function (e) {
                            var checked = e.target.checked;
                            if (checked) {
                                field.onChange(__spreadArray(__spreadArray([], (field.value || []), true), [branch], false));
                            }
                            else {
                                field.onChange((field.value || []).filter(function (b) { return b !== branch; }));
                            }
                        }}/>
                              {branch}
                            </label>);
                  ...
                  <FormField control={form.control} name="deployments" render={function (_a) {
            var field = _a.field;
            return (<FormItem>
                    ...
                    var _a;
                    return (<label key={dep} className="flex items-center gap-2">
                              <input type="checkbox" checked={((_a = field.value) === null || _a === void 0 ? void 0 : _a.includes(dep)) || false} onChange={function (e) {
                            var checked = e.target.checked;
                            if (checked) {
                                field.onChange(__spreadArray(__spreadArray([], (field.value || []), true), [dep], false));
                            }
                            else {
                                field.onChange((field.value || []).filter(function (d) { return d !== dep; }));
                            }
                        }}/>
                              {dep}
                            </label>);
